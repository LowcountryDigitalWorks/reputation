...
**Current documentation maintenance:** 0.1.1 — Accepted-State Documentation Maintenance

**Portfolio state:** **DORMANT** — no functional Reputation implementation is currently authorized.
